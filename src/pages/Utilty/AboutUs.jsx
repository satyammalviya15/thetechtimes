      ...
      <div className="row mt-5">
        <div className="col-md-8">
          ...
          <h3 className="mt-4">Who We Are</h3>
            <p>
              Founded in 2025, The Tech Times has quickly grown into a trusted voice in the tech community. Our team of experienced journalists, researchers, and tech experts are dedicated to digging deep into the stories that matter—from AI breakthroughs and cybersecurity to the latest gadget releases and startup successes.
            </p>
          </div>
          ...
          <div className="card border-0 bg-light p-4">
            ...
            <ul className="list-unstyled mt-3">
              <li className="mb-2"><strong>Founded:</strong> 2025</li>
